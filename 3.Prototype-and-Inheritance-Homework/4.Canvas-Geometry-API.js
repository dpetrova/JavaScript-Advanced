// this program is entirely taken from milen-vm for learning purpose only!!!
var Shape = (function() {
    ...
    function setSideLength(x1, y1, x2, y2) {
        var length,
            squareDiffX,
            squareDiffY;
        squareDiffX = Math.pow((x1 - x2), 2);
        squareDiffY = Math.pow((y1 - y2), 2);
    ...
    function isValidTriangle(lengthAB, lengthAC, lengthBC) {
        var sideBCtoA,
            ...
            sideABtoC,
            isValidTriangle;
        sideBCtoA = lengthAB + lengthAC > lengthBC;
        sideACtoB = lengthBC + lengthAB > lengthAC;
        sideABtoC = lengthBC + lengthAC > lengthAB;
        isValidTriangle = sideABtoC && sideACtoB && sideBCtoA;
